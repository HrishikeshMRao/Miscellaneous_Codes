...
% Letter "U"
U_tag = linspace(0,pi,100);
x1 = 1*cos (U_tag)+2;
y1 = -2.1*sin (U_tag)+3.1;

% Letter R
x6= linspace(4,4,100);
y6 = linspace(1,3.1,100);
T_tag = linspace(pi/4.9, 3*pi/4.9, 100);
...
Final_Y = horzcat(y1,y6,y7,y8,y9);
Final_X = horzcat(x1,x6,x7,x8,x9 );
